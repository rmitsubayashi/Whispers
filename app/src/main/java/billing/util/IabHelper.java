...
public class IabHelper {
     ...
     * @param extraData Extra com.linnca.whispers.data (developer payload), which will be returned with the purchase
     *      com.linnca.whispers.data when the purchase completes. This extra com.linnca.whispers.data will be permanently bound to that
     ...
     * @param data The com.linnca.whispers.data (Intent) as you received it.
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data == null) {
            logError("Null com.linnca.whispers.data in IAB activity result.");
            result = new IabResult(IABHELPER_BAD_RESPONSE, "Null com.linnca.whispers.data in IAB result");
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            logDebug("Purchase com.linnca.whispers.data: " + purchaseData);
            ...
            try {
                ...
                logError("Failed to parse purchase com.linnca.whispers.data.");
                e.printStackTrace();
                result = new IabResult(IABHELPER_BAD_RESPONSE, "Failed to parse purchase com.linnca.whispers.data.");
                if (mPurchaseListener != null) mPurchaseListener.onIabPurchaseFinished(result, null);
                return true;
            }
