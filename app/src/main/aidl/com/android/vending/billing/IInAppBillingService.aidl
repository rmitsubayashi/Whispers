...
interface IInAppBillingService {
     ...
     * If the purchase is successful, the result com.linnca.whispers.data will contain the following key-value pairs
     ...
     *         "INAPP_DATA_SIGNATURE" - String containing the signature of the purchase com.linnca.whispers.data that
     ...
     * purchase information and a signature of the com.linnca.whispers.data to be validated.
